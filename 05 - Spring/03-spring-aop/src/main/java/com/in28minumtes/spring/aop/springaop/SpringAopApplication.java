...
public class SpringAopApplication implements CommandLineRunner {
	...
	// This means we can Autwire the Beans and no longer need to get them from the Application Context
	// With the CommandLineRunner, we can pass anything in the command line an it will run.
